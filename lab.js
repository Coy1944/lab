...
if(rain === true) {
  if(temperature >= 80) console.log ("one should wear a t-shirts and take an umbrella")
  else if (temperature > 60 && temperature < 80) console.log("one should wear a rain-jacket");
}

if(rain === false) {
  if(temperature <= 32) console.log("you should wear a winter coat today. It looks like its below freezing")
  else if (temperature > 32 && temperature < 70) console.log("You should wear a long shirt. its chilly")
  else if (temperature >= 70) console.log(" You should wear a tshirt today. it appears warm");

}

else if (temperature <= 60 && temperature > 32) console.log("One should wear a jacket and carry an umbrella")
else console.log("Im not sure what you should wear today");
////////// PROBLEM 5 //////////
